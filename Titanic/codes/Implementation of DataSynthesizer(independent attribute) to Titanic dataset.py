...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  7 01:01:55 2022
...
# input dataset
input_data = 'titanic.csv'
# location of two output files
mode = 'independent_attribute_mode'
description_file = 'description_for_titanic_dataset.json'
synthetic_data = 'synthetic_data_for_titanic_dataset_independent_mode.csv'
# An attribute is categorical if its domain size is less than this threshold.
threshold_value = 2

# specify categorical attributes
categorical_attributes = {'Survived': True}
